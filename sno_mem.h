...
void* sno_realloc(struct sno_State* state, void* block, size_t old_size, size_t new_size);
#define sno_alloc_type(state, type) (type*)sno_calloc(state, 1, sizeof(type))
void sno_free(struct sno_State* state, void* block, size_t size);
...
void sno_dynarray_push_back_ptr(struct sno_State* state, sno_DynArray* dynarray, const void* sno_restrict ptr);
void sno_dynarray_push_back_ptr_no_resize(struct sno_State* state, sno_DynArray* dynarray, const void* sno_restrict ptr);
